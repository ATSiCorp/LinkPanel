...
return [
    ...
    */
    ...
    'server_setup_step7' => 'LinkPanel doesn\'t work with NAT VPN and OpenVZ or in localhost',
    'server_setup_step8' => 'Before install LinkPanel, please make sure your server is a clean Ubuntu 20.04 LTS VPS',
    ...
    'reset_linkpanel_password' => 'Reset LinkPanel user password',
    'require_reset_linkpanel_password' => 'Require Reset',
    'hd_memory_usage' => 'HD Memory Usage',
    'linkpanel_build_version' => 'LinkPanel Build Version',
    ...
    'require_password_reset_modal_text' => 'Are you sure to reset LinkPanel user password?',
    'new_password_success' => 'New LinkPanel user password',
